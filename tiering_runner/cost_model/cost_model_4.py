...
class CostModel4(CostModel):
    ...
    def get_cost(self, segment, calibration_values_per_datatype: Dict[str, List[float]], device: TieringDevice):
        ...
        cost = cost * (segment["size_in_bytes"] / segment["num_tuples"]) # size per value, bigger segments are more expensive to load into memory
